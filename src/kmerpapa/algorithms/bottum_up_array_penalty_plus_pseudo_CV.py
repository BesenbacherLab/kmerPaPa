...
def pattern_partition_bottom_up(gen_pat, contextD, alphas, args, nmut, nunmut, penalties, index_mut=0):
    ...
    # nit is number of iterations if we do repeated CV
...
def pattern_partition_bottom_up_kmer_table(gen_pat, contextD, alphas, args, nmut, nunmut, penalties, index_mut=0):
    global cgppl
    global gppl
    global gpo
    global gen_pat_len
